...
public class TestAccounts {
	public static void main(String args[]) {
		...
		ca1.setOdl(200);
		// Credit some cash to ChequeAccount object, using method defined in the Account
		// super class
		ca1.credit(500);
		...
		// Debit some cash from ChequeAccount object, using method defined in the
		// Account super class
		...
		if (ca1.debit(800))
			...
			System.out.println(" Debit of 800 Failed");
